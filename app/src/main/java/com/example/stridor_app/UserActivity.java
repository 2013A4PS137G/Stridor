...
/**
 * Shows user data and Recordings; new recording
 */
public class UserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * redirects to Camera app for recording
     */
    ...
    /**
     * Checks for User permissions to Record Video and if true calls dispatchTakeVideoIntent()
     */
    ...
    /**
     * Executes after video is recorded with camera app
     * Saves video meta-data to Firebase DB
     */
    @Override
    ...
    /**
     * Executes when video recording is clicked: Opens VideoShowActivity
     */
    private void showVideo(Uri videoUri){
        Intent i = new Intent(UserActivity.this,VideoShowActivity.class);
        i.putExtra("videoUri",videoUri);
        startActivity(i);
    }

    /**
     * TODO : Executes when audio recording is clicked
     */
...
//        String mime = getContentResolver().getType(audioUri);
        ...
        //Wrong Implementation - use AudioShowActivity
    ...
    /**
     * Sets the values of user meta-data to UI
     */
    ...
    /**
     * Fetches data from firebase database for list of recordings and populates it into the listview
     */
            ...
            DBManager.fetchRecordings(this.uid, new DBManager.DataSnapshotCallback() {
                ...
                public void onSuccess(DataSnapshot value) {
                    ...
                    for(DataSnapshot it : value.getChildren()){
                        ...
                        RecordingCard card = new RecordingCard(UserActivity.this,uid,ts, media,path,task,duration, rec_id);
     ...
     * Currently, only buttonRecord and buttonDelete
     * @param v
     */
    @Override
    ...
    /** Opens popup window when record button is clicked.
     * prompts user input for Recording type and task
     * @param view
     */
            ...
            public void onClick(View v) {
                ...
                if(rec_id == null || rec_id.length() == 0){
                    ...
                    if (media_dropdown.getSelectedItem().toString().equalsIgnoreCase("AUDIO")) {
                        // If Audio
                        Intent i = new Intent(UserActivity.this, RecordAudioActivity.class);
                        startActivity(i);
                    } else {
                        // If Video
    ...
    /**
     * Inserts recording to Firebase DB with required data
     */
    ...
    /**
     * Gets called when current activity is started with a Intent
     * currently when it returns from RecordAudioActivity
     */
    ...
    /**
     * called when activity is resumed ie., switch to another app and navigated back
     */
    @Override
